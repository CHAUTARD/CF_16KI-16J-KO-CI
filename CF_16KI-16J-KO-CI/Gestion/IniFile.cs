...
namespace Criterium_16_4
{
    ...
    public class IniFile
    {
        ...
        {
            this.sFileName = String.Format("{0}{1}{2}", Application.StartupPath, Path.DirectorySeparatorChar, _sFileName);

            if (!File.Exists(_sFileName))
                File.Create(_sFileName); 
        }
        ...
        public string ReadString(string section, string key)
        {
            ...
            GetPrivateProfileString(section, key, "", temp, bufferSize, sFileName);
        ...
        public string[] ReadSection(string section)
        {
            ...
            try
            {
                int bytesReturned = GetPrivateProfileSection(section, pReturnedString, bufferSize, sFileName);
